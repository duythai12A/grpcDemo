...
public final class GreetingServiceGrpc {
    ...
    public static final String SERVICE_NAME = "dev.sultanov.grpc.authentication.shared.GreetingService";

    // Static method descriptors that strictly reflect the proto.
    private static volatile io.grpc.MethodDescriptor<dev.sultanov.grpc.authentication.shared.GreetingRequest,
            dev.sultanov.grpc.authentication.shared.GreetingResponse> getGreetingMethod;

    @io.grpc.stub.annotations.RpcMethod(
            fullMethodName = SERVICE_NAME + '/' + "greeting",
            requestType = dev.sultanov.grpc.authentication.shared.GreetingRequest.class,
            responseType = dev.sultanov.grpc.authentication.shared.GreetingResponse.class,
            methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<dev.sultanov.grpc.authentication.shared.GreetingRequest,
            dev.sultanov.grpc.authentication.shared.GreetingResponse> getGreetingMethod() {
        io.grpc.MethodDescriptor<dev.sultanov.grpc.authentication.shared.GreetingRequest, dev.sultanov.grpc.authentication.shared.GreetingResponse> getGreetingMethod;
            ...
            synchronized (GreetingServiceGrpc.class) {
                if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
                    GreetingServiceGrpc.getGreetingMethod = getGreetingMethod =
                            io.grpc.MethodDescriptor.<dev.sultanov.grpc.authentication.shared.GreetingRequest, dev.sultanov.grpc.authentication.shared.GreetingResponse>newBuilder()
                                    .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                                    .setFullMethodName(generateFullMethodName(
                                            "dev.sultanov.grpc.authentication.shared.GreetingService", "greeting"))
                                    .setSampledToLocalTracing(true)
                                    .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            dev.sultanov.grpc.authentication.shared.GreetingRequest.getDefaultInstance()))
                                    .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            dev.sultanov.grpc.authentication.shared.GreetingResponse.getDefaultInstance()))
    ...
    public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
        ...
        /**
         */
        public void greeting(dev.sultanov.grpc.authentication.shared.GreetingRequest request,
                             io.grpc.stub.StreamObserver<dev.sultanov.grpc.authentication.shared.GreetingResponse> responseObserver) {
        ...
        @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            ...
                            asyncUnaryCall(
                                    new MethodHandlers<
                                            dev.sultanov.grpc.authentication.shared.GreetingRequest,
                                            dev.sultanov.grpc.authentication.shared.GreetingResponse>(
    ...
    public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
        ...
        /**
         */
        public dev.sultanov.grpc.authentication.shared.GreetingResponse greeting(dev.sultanov.grpc.authentication.shared.GreetingRequest request) {
    ...
    public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
        ...
        /**
         */
        public com.google.common.util.concurrent.ListenableFuture<dev.sultanov.grpc.authentication.shared.GreetingResponse> greeting(
                dev.sultanov.grpc.authentication.shared.GreetingRequest request) {
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_GREETING:
                    serviceImpl.greeting((dev.sultanov.grpc.authentication.shared.GreetingRequest) request,
                            (io.grpc.stub.StreamObserver<dev.sultanov.grpc.authentication.shared.GreetingResponse>) responseObserver);
                    break;
                default:
    ...
    private static abstract class GreetingServiceBaseDescriptorSupplier
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return dev.sultanov.grpc.authentication.shared.GreetingServiceOuterClass.getDescriptor();
        }
